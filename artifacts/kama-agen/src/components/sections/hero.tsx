...
export function Hero() {
  ...
  return (
    <section className="relative min-h-[100dvh] flex items-center pt-20 pb-12 lg:pb-0 overflow-hidden bg-grid">
      {/* Background */}
      ...
      <div className="container mx-auto px-6 z-10 grid lg:grid-cols-2 gap-10 lg:gap-12 items-center">
        {/* ── Text column ── */}
        <motion.div
        ...
        >
          ...
          <h1
            className="text-5xl sm:text-7xl lg:text-8xl font-black leading-none text-white drop-shadow-[0_0_10px_rgba(204,255,0,0.3)] flex items-center gap-3"
          ...
          <p className="text-muted-foreground font-mono text-sm sm:text-lg max-w-2xl text-left leading-relaxed">
            The next-generation autonomous AI crypto agent. Executing DeFi strategies, analyzing sentiment, and trading on-chain{' '}
            <span className="text-white font-bold">24/7 without human intervention</span>.
          </p>
          ...
          <div className="mt-4 lg:mt-8 flex gap-8 border-t border-white/10 pt-6">
            <div>
        ...
        {/* ── Image column — visible on all sizes ── */}
        <motion.div
        ...
        >
          ...
          <div className="relative z-10 w-full aspect-[4/3] sm:aspect-[3/4] lg:aspect-[3/4] bg-black border border-primary/20 overflow-hidden shadow-[0_0_50px_rgba(0,255,65,0.15)] group">
            <img
              src={mascotImg}
              alt="LIZA OS AI Agent"
              className="w-full h-full object-cover object-top sm:object-center opacity-90 group-hover:scale-105 transition-transform duration-700 mix-blend-lighten"
            />
            ...
            <div className="absolute bottom-6 left-6 right-6 flex justify-between items-end border-t border-primary/30 pt-4">
              <div>
                ...
                <div className="text-white font-mono font-bold tracking-widest text-sm">LIZA_CORE_PROCESS</div>
              </div>
              <div className="w-10 h-10 lg:w-12 lg:h-12 border border-primary/50 flex items-center justify-center bg-black/50 backdrop-blur">
                <div className="w-5 h-5 lg:w-6 lg:h-6 border border-primary border-t-transparent rounded-full animate-spin" />
              </div>
            </div>
          </div>
        </motion.div>
